...
export function MovieCard({ movieData }: MovieCardProps) {
  ...
  return (
    <div className="flex justify-start">
      <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center flex-shrink-0 mr-3">
        <span className="text-white text-sm">🎬</span>
      </div>
      
      <div className="movie-card rounded-2xl overflow-hidden max-w-md">
        <div className="flex">
          <img 
            src={posterUrl} 
            alt={movieData.title}
